-- Copyright https://medium.com/@vbilopav/custom-temporal-tables-in-postgresql-5a0e4045ab30
...
-- Init temporal table(s) function
...
-- Execute
select temporal_support.init_temporal_tables('customers', 'users');
